...
GOVERNANCE_FILES = [
    ...
    "docs/agents/90-release-checklist.md",
    "docs/agents/workflow-registry.md",
    "docs/agents/automation/overview.md",
    "docs/agents/automation/nightly-compound-loop.md",
    "docs/agents/automation/pr-control-plane-loop.md",
    "docs/agents/skills/00-skill-standards.md",
    "docs/agents/skills/10-platform-adapters.md",
    "docs/agents/subagents/00-subagent-standards.md",
    "docs/agents/platforms/00-platform-runtime-standards.md",
    "docs/agents/acp/00-acp-standards.md",
    "docs/agents/mcp/00-mcp-standards.md",
    "docs/agents/settings/00-settings-standards.md",
    "docs/agents/playbooks/rca-methods-template.md",
    "docs/agents/playbooks/bugfix-template.md",
    "docs/agents/playbooks/design-principles-checklist.md",
...
FILE_TOPIC_MAP = {
    ...
    "00-principles.md": ["AI agent first principles", "coding agent design principles"],
    "05-context-retrieval.md": ["AI agent context injection", "LLM context management coding"],
    "10-repo-discovery.md": ["AI agent repo discovery", "codebase exploration agent"],
    "20-sources-of-truth-map.md": ["single source of truth code", "SSOT software architecture"],
    "25-docs-ssot-policy.md": ["documentation as code", "docs single source of truth"],
    "30-logging-errors.md": ["AI agent error handling", "coding agent logging observability"],
    "35-authority-bounded-modules.md": ["module boundaries authority", "bounded context software"],
    "40-config-constants.md": ["configuration management constants", "config as code"],
    "70-io-data-integrity.md": ["data integrity file processing", "IO safety coding agent"],
    "80-testing-real-files.md": ["AI agent testing strategy", "coding agent test automation"],
    "90-release-checklist.md": ["release checklist automation", "CI CD agent workflow"],
    "workflow-registry.md": ["workflow state machine", "agent workflow orchestration"],
    "overview.md": ["AI agent automation loop", "autonomous coding loop"],
    "nightly-compound-loop.md": ["nightly automation agent", "compound improvement loop AI"],
    "pr-control-plane-loop.md": ["PR automation agent", "pull request AI workflow"],
    "00-skill-standards.md": ["Claude Code skills", "AI agent skills standard"],
    "10-platform-adapters.md": ["multi-platform agent", "agent platform adapter"],
    "00-subagent-standards.md": ["subagent orchestration", "multi-agent coordination"],
    "00-platform-runtime-standards.md": ["agent runtime standard", "coding agent platform runtime"],
    "00-acp-standards.md": ["agent communication protocol", "ACP standard agent"],
    "00-mcp-standards.md": ["MCP server standard", "model context protocol agent"],
    "00-settings-standards.md": ["agent settings configuration", "coding agent permissions"],
    "rca-methods-template.md": ["root cause analysis AI", "RCA debugging agent"],
    "bugfix-template.md": ["AI bugfix workflow", "agent debugging template"],
    "design-principles-checklist.md": ["software design principles AI", "SOLID DRY agent coding"],
    "governance-learnings-template.md": ["governance framework learnings", "AI governance improvement"],
    "ai-coding-prompt-template.md": ["AI coding prompt engineering", "agent prompt template"],
}
