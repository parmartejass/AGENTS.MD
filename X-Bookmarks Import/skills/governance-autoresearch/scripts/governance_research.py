...
GOVERNANCE_FILES = [
    ...
    "docs/agents/automation/overview/overview.md",
    "docs/agents/automation/nightly-compound-loop/nightly-compound-loop.md",
    "docs/agents/automation/pr-control-plane-loop/pr-control-plane-loop.md",
    ...
    "docs/agents/acp/00-acp-standards/acp-standards.md",
...
FILE_TOPIC_MAP = {
    ...
    "docs/agents/automation/overview/overview.md": ["AI agent automation loop", "autonomous coding loop"],
    "docs/agents/automation/nightly-compound-loop/nightly-compound-loop.md": ["nightly automation agent", "compound improvement loop AI"],
    "docs/agents/automation/pr-control-plane-loop/pr-control-plane-loop.md": ["PR automation agent", "pull request AI workflow"],
    ...
    "docs/agents/subagents/00-subagent-standards/subagent-standards.md": ["subagent orchestration", "multi-agent coordination"],
    "docs/agents/platforms/00-platform-runtime-standards/platform-runtime-standards.md": ["agent runtime standard", "coding agent platform runtime"],
    "docs/agents/acp/00-acp-standards/acp-standards.md": ["agent communication protocol", "ACP standard agent"],
    "docs/agents/mcp/00-mcp-standards/mcp-standards.md": ["MCP server standard", "model context protocol agent"],
