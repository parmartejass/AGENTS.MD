...
- After reading `AGENTS.md`, follow its "Context Injection Procedure (Hard Gate)" section (consult `agents-manifest.yaml`, load injected docs/playbooks, and use `fallback_inject` if no profile matches).
