...
todos:
  - id: add-policy-doc
    content: Create `docs/agents/35-authority-bounded-modules/authority-bounded-modules.md` with required header and repo-agnostic rules + witnesses.
    status: pending
  - id: update-agents-md
  ...
  - id: update-ssot-map-index
    content: Update `docs/agents/20-sources-of-truth-map/sources-of-truth-map.md` (schema/types + module boundaries/contracts) and link new doc from `docs/agents/agents_index.md`.
    status: pending
  - id: verify-checks
...
- Ensure the new doc is **not orphaned** (linked from `docs/agents/agents_index.md`).
...
- Concept→owner mapping remains centralized in `[docs/agents/20-sources-of-truth-map/sources-of-truth-map.md](docs/agents/20-sources-of-truth-map/sources-of-truth-map.md)`.

## Implementation outline (minimal diffs)

- **Create** `[docs/agents/35-authority-bounded-modules/authority-bounded-modules.md](docs/agents/35-authority-bounded-modules/authority-bounded-modules.md)` (doc header required per `docs/agents/25-docs-ssot-policy/docs-ssot-policy.md`).
  ...
  - Reference existing SSOT docs instead of duplicating their content (e.g., `docs/agents/20-sources-of-truth-map/sources-of-truth-map.md`, `docs/agents/10-repo-discovery/repo-discovery.md`, `docs/agents/40-config-constants/config-constants.md`).
...
- **Update** `[docs/agents/20-sources-of-truth-map/sources-of-truth-map.md](docs/agents/20-sources-of-truth-map/sources-of-truth-map.md)`:
  - Add a **Schema / types / data model** category (single owner; used across modules).
  - Add a **Module boundaries + contracts** category, pointing to the new policy doc and (in target repos) to `docs/project/architecture/architecture_index.md` as the place to record the authority graph/boundaries.
- **Update** `[docs/agents/agents_index.md](docs/agents/agents_index.md)`:
