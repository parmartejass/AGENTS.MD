...
update_trigger:
  ...
  - governance decisions in docs/project/learning/learning.md change
---
...
- Authority owner: `docs/agents/playbooks/governance-learnings-template/governance-learnings-template.md`.
