...
- Use this doc when `docs/agents/20-sources-of-truth-map.md` is too abstract and project docs are too local.
- Keep this doc limited to decision records and migration contracts. Do not restate policy already owned by `AGENTS.md`, `docs/agents/20-sources-of-truth-map.md`, or `docs/agents/25-docs-ssot-policy.md`.
...
## Out of Scope
- Project-local architecture choices; keep those in `docs/project/architecture.md`.
- Repeating repo-wide SSOT policy; keep that in `AGENTS.md`.
- Repeating concept -> owner routing; keep that in `docs/agents/20-sources-of-truth-map.md`.
...
- Verification witness:
  - `python3 scripts/check_governance_core.py` passes.
...
- Forbidden duplicates:
  ...
  - Do not restate concrete runtime mapping facts in `README.md` or `docs/project/platform-runtime-status.md` as parallel authorities
...
- Coordinated update set:
  ...
  - `docs/project/platform-runtime-status.md`
...
- Verification witness:
  ...
  - `docs/project/platform-runtime-status.md` references runtime projections and source owners rather than restating concrete mapping facts as SSOT
