...
This reference supplies verification questions for the request contract in `docs/agents/governance/skills/x-api-data-access/SKILL.md`. Current endpoint and account authorities supply the answers; this file defines no numeric quota, retention window, auth default, or retry schedule.
