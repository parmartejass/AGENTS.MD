...
- Codex official skill path: see `docs/agents/platforms/codex/2026-03-06-official-runtime/evidence.md`
- Claude Code official skill/agent surfaces: see `docs/agents/platforms/claude-code/2026-03-06-official-runtime/evidence.md`
- Cursor official rule surface: see `docs/agents/platforms/cursor/2026-03-06-official-runtime/evidence.md`
