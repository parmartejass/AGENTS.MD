...
This reference supports the request contract in `docs/agents/skills/x-api-data-access/SKILL.md`. The endpoint's current official authentication mapping owns supported auth methods and scopes; this file maintains no local scope bundles or endpoint-specific auth defaults.
