...
- In repos that use `.governance/` as a submodule, do NOT edit `.governance/` from the parent repo.
  ...
  - See `docs/agents/playbooks/governance-learnings-template/governance-learnings-template.md`.
...
- Update the project learning doc (default: `docs/project/learning/learning.md`).
