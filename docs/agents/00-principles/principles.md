...
- Playbooks (`docs/agents/playbooks/index.md` and child branches): copy/paste templates and checklists.
- Platform assets (`docs/agents/skills/00-skill-standards/skill-standards.md`, `docs/agents/subagents/00-subagent-standards/subagent-standards.md`, `docs/agents/mcp/00-mcp-standards/mcp-standards.md`, `docs/agents/acp/00-acp-standards/acp-standards.md`): repo-owned runtime assets and standards; reference core policy, do not duplicate it.
