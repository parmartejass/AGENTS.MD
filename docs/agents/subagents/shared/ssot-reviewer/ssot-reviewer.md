...
## Reference Docs
- `docs/agents/20-sources-of-truth-map/sources-of-truth-map_index.md` — Concept -> owner map
- `docs/agents/35-authority-bounded-modules/authority-bounded-modules_index.md` — Module boundary alignment
