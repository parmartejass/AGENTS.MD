...
- [ ] `docs/project/goal/goal.md` - Objective + acceptance criteria
- [ ] `docs/project/rules/rules.md` - Project do/don't rules
- [ ] `docs/project/architecture/architecture.md` - SSOT pointers
- [ ] `docs/project/learning/learning.md` - Operational learnings
