...
From AGENTS.md section "Governance Auto-Edit Gate (Hard Gate)":
...
From AGENTS.md section "Governance Auto-Edit Gate (Hard Gate)" > "Confirmation gate":
...
- `docs/agents/05-context-retrieval/context-retrieval_index.md`
- `docs/agents/playbooks/governance-learnings-template/governance-learnings-template_index.md`
