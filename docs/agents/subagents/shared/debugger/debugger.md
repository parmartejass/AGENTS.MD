...
- `docs/agents/playbooks/bugfix-template/bugfix-template_index.md`
- `docs/agents/playbooks/rca-methods-template/rca-methods-template_index.md`
- `docs/agents/15-stuck-in-loop-generate-fresh-restart-prompt/stuck-in-loop-generate-fresh-restart-prompt_index.md`
