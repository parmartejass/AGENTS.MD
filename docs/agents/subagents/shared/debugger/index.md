...
- `docs/agents/playbooks/bugfix-template/index.md`
- `docs/agents/playbooks/rca-methods-template/index.md`
- `docs/agents/15-stuck-in-loop-generate-fresh-restart-prompt/index.md`
